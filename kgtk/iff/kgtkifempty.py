...
class KgtkIfEmpty(KgtkFormat):
    ...
    filter_column_names: typing.List[str] = attr.ib(
    ...
    def filter(self, row: typing.List[str], filter_idx_list: typing.List[int]) -> bool:
        idx: int
    ...
    def process(self):
        ...
        if self.only_count:
            print(
                "Read %d records, %d records passed the filter."
...
def main():
    ...
    parser.add_argument(
        "--all",
        dest="all_are",
        help="False: Test if any are, True: test if all are (default=%(default)s).",
        type=optional_bool,
        nargs="?",
        const=True,
        default=False,
    ...
    parser.add_argument(
        "--not-empty",
        dest="notempty",
        help="False: test if empty, True: test if not empty (default=%(default)s).",
        type=optional_bool,
        nargs="?",
        const=True,
        default=False,
