...
def parser():
    return {"help": "Find reachable nodes in a graph."}
...
def add_arguments(parser):
    ...
    parser.add_argument(
        ...
        dest="filename",
        metavar="filename",
        help="input filename here",
    )
    parser.add_argument(
        "--root",
        action="store",
        dest="root",
        help="Set of root nodes to use, comma-separated string",
        default=None,
    )
    parser.add_argument(
        "--rootfile",
    ...
    parser.add_argument(
        ...
        type=int,
        dest="rootfilecolumn",
        help="Option to specify column of roots file to use, default 0",
        default=0,
    )
    parser.add_argument(
        "--norootheader",
        action="store_true",
        dest="root_header_bool",
        help="Option to specify that root file has no header",
    )
    parser.add_argument(
        "-o",
        "--out",
        ...
        type=str,
        dest="output",
        help="File to output the reachable nodes,if empty will be written out to standard output",
        default=None,
    )
    parser.add_argument(
        "--noheader",
        action="store_true",
        dest="header_bool",
        help="Option to specify that file does not have a header",
    )
    parser.add_argument(
        "--subj",
        action="store",
        type=int,
        dest="sub",
        help="Column in which the subject is given, default 0",
        default=0,
    )
    parser.add_argument(
        "--obj",
        ...
        type=int,
        dest="obj",
        help="Column in which the subject is given, default 2",
        default=2,
    )
    parser.add_argument(
        "--pred",
        ...
        type=int,
        dest="pred",
        help="Column in which predicate is given, default 1",
        default=1,
    )
    parser.add_argument(
        "--props",
        ...
        type=str,
        dest="props",
        help="Properties to consider while finding reachable nodes - comma-separated string,default all properties",
        default=None,
    )
    parser.add_argument(
        "--undirected",
        action="store_true",
        dest="undirected",
        help="Option to specify graph as undirected?",
    )
...
def run(
    ...
    if output:
        ...
        tsv_writer = csv.writer(
            f, quoting=csv.QUOTE_NONE, delimiter="\t", escapechar="\n", quotechar=""
        )
        if index_list == []:
