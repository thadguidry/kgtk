...
def parser():
    return {"help": "Merge identical nodes and deduplicate."}
...
def add_arguments(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        dest="nodes_file",
        help="TSV file with node columns.",
    )
    parser.add_argument(
        "-ef",
        "--edge-file",
        ...
        type=str,
        dest="edges_file",
        help="TSV file with edge columns.",
    )
    parser.add_argument(
        "-l",
        "--label",
        ...
        type=str,
        dest="label",
        help="Relation label indicating identity",
    )
