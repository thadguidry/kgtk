...
def parser():
    return {"help": "Import a CSV file in Graph-tool."}
...
def run(
    ...
    try:
        ...
        with open(log_file, "w") as writer:
            ...
            writer.write(
                "graph loaded! It has %d nodes and %d edges\n"
