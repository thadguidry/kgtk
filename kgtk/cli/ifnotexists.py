...
def add_arguments_extended(parser: KGTKArgumentParser, parsed_shared_args: Namespace):
    ...
    parser.add_argument(
        "--filter-on",
        dest="filter_kgtk_file",
        help="The KGTK file to filter against (required).",
        type=Path,
        required=True,
    )
    ...
    parser.add_argument(
        ...
        help="The KGTK file to write (required),",
        type=Path,
        default=None,
    )
    ...
    KgtkReaderOptions.add_arguments(
        parser, mode_options=True, who="input", expert=_expert, defaults=False
    )
    KgtkReaderOptions.add_arguments(
        parser, mode_options=True, who="filter", expert=_expert, defaults=False
    )
...
def run(
    ...
    **kwargs  # Whatever KgtkFileOptions and KgtkValueOptions want.
    ...
    if show_options:
        ...
        print(
            "--filter-on=%s"
            % (str(filter_kgtk_file) if filter_kgtk_file is not None else "-"),
            file=error_file,
        )
