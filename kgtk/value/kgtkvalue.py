...
class KgtkValueFields:
    data_type: KgtkFormat.DataType = attr.ib(
        validator=attr.validators.instance_of(KgtkFormat.DataType)
    )
    ...
    language: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )

    # The language code suffix, including the leading dash.
    suffix: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )

    # Offer the components of a number or quantity, after validating the item.
    numberstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    number: typing.Optional[typing.Union[int, float]] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of((int, float))),
        default=None,
    )

    low_tolerancestr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    low_tolerance: typing.Optional[float] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(float)),
        default=None,
    )

    high_tolerancestr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    high_tolerance: typing.Optional[float] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(float)),
        default=None,
    )

    si_units: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )

    wikidata_node: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )

    # Offer the components of a location coordinates, after validaating the item:
    latitudestr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    latitude: typing.Optional[float] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(float)),
        default=None,
    )

    longitudestr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    longitude: typing.Optional[float] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(float)),
        default=None,
    )

    # Offer the components of a date and times, after validating the item:
    date: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    time: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )  # includes timezone
    date_and_time: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )  # includes timezone

    yearstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    year: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    monthstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    month: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    daystr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    day: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    hourstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    hour: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    minutesstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    minutes: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    secondsstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    seconds: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    # Z or [-+]HH or [-+]HHMM or [-+]HH:MM
    zonestr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )

    precisionstr: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    precision: typing.Optional[int] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(int)),
        default=None,
    )

    # True when hyphens/colons are present.
    iso8601extended: typing.Optional[bool] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(bool)),
        default=None,
    )

    # Offer the contents of a boolean, after validating the item:
    truth: typing.Optional[bool] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(bool)),
        default=None,
    )

    # Everything else must be a symbol.
    symbol: typing.Optional[str] = attr.ib(
        validator=attr.validators.optional(attr.validators.instance_of(str)),
        default=None,
    )
    ...
    DATA_TYPE_FIELDS: typing.Mapping[str, typing.List[str]] = {
        ...
        KgtkFormat.DataType.QUANTITY.lower(): [
            "valid",
            "numberstr",
            "number",
            "low_tolerancestr",
        ...
        KgtkFormat.DataType.LANGUAGE_QUALIFIED_STRING.lower(): [
            "valid",
            "text",
            "language",
            "suffix",
        ],
        KgtkFormat.DataType.LOCATION_COORDINATES.lower(): [
            "valid",
            "latitudestr",
            "latitude",
            "longitudestr",
        ...
        KgtkFormat.DataType.DATE_AND_TIMES.lower(): [
            "valid",
            "date_and_time",
            "date",
            "time",
...
class KgtkValue(KgtkFormat):
    ...
    options: KgtkValueOptions = attr.ib(
        validator=attr.validators.instance_of(KgtkValueOptions),
        default=DEFAULT_KGTK_VALUE_OPTIONS,
    )
    parse_fields: bool = attr.ib(
    ...
    split_list_re: typing.Pattern = re.compile(
        r"(?<!\\)" + "\\" + KgtkFormat.LIST_SEPARATOR
    )
            ...
            for item_value in values:
                self.list_items.append(
                    KgtkValue(
                        ...
                        parse_fields=self.parse_fields,
                        parent=self,
                    )
                )
        return self.list_items
    ...
    def is_list(self, validate: bool = False) -> bool:
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=KgtkFormat.DataType.LIST,
                valid=False,
    ...
    digit_pat: str = r"[0-9]"
    decinteger_pat: str = r"(?:{digit}(?:_?{digit})*{long_suffix}?)".format(
        digit=digit_pat, long_suffix=long_suffix_pat
    )
    bindigit_pat: str = r"[01]"
    bininteger_pat: str = r'(?:0[bB](":_?{bindigit})+{long_suffix})'.format(
        bindigit=bindigit_pat, long_suffix=long_suffix_pat
    )
    octdigit_pat: str = r"[0-7]"
    octinteger_pat: str = r'(?:0[oO](":_?{octdigit})+{long_suffix})'.format(
        octdigit=octdigit_pat, long_suffix=long_suffix_pat
    )
    hexdigit_pat: str = r"[0-7a-fA-F]"
    hexinteger_pat: str = r'(?:0[xX](":_?{hexdigit})+{long_suffix})'.format(
        hexdigit=hexdigit_pat, long_suffix=long_suffix_pat
    )

    integer_pat: str = r"(?:{decinteger}|{bininteger}|{octinteger}|{hexinteger})".format(
        decinteger=decinteger_pat,
    ...
    pointfloat_pat: str = r"(?:{digitpart}?{fraction})|(?:{digitpart}\.)".format(
        digitpart=digitpart_pat, fraction=fraction_pat
    )
    exponent_pat: str = r"(?:[eE]{plus_or_minus}?{digitpart})".format(
        plus_or_minus=plus_or_minus_pat, digitpart=digitpart_pat
    )
    exponentfloat_pat: str = r"(?:{digitpart}|{pointfloat}){exponent}".format(
        digitpart=digitpart_pat, pointfloat=pointfloat_pat, exponent=exponent_pat
    )
    floatnumber_pat: str = r"(?:{pointfloat}|{exponentfloat})".format(
        pointfloat=pointfloat_pat, exponentfloat=exponentfloat_pat
    )

    # Imaginary literals.
    imagnumber_pat: str = r"(?:{floatnumber}|{digitpart})[jJ]".format(
        floatnumber=floatnumber_pat, digitpart=digitpart_pat
    )

    # Numeric literals.
    numeric_pat: str = r"(?:{plus_or_minus}?(?:{integer}|{floatnumber}|{imagnumber}))".format(
        plus_or_minus=plus_or_minus_pat,
        integer=integer_pat,
    ...
    # Tolerances
    tolerance_pat: str = r"(?:\[(?P<low_tolerance>{numeric}),(?P<high_tolerance>{numeric})\])".format(
        numeric=numeric_pat
    )
    ...
    si_pat: str = r"(?P<si_units>{si_unit}{si_power}?(?:{si_combiner}{si_unit}{si_power}?)*)".format(
        si_unit=si_unit_pat, si_combiner=si_combiner_pat, si_power=si_power_pat
    )
    # Wikidata nodes (for units):
    nonzero_digit_pat: str = r"[1-9]"
    wikidata_node_pat: str = r"(?P<wikidata_node>Q{nonzero_digit}{digit}*)".format(
        nonzero_digit=nonzero_digit_pat, digit=digit_pat
    )

    units_pat: str = r"(?:{si}|{wikidata_node})".format(
        si=si_pat, wikidata_node=wikidata_node_pat
    )

    # This definition matches numbers or quantities.
    number_or_quantity_pat: str = r"{numeric}{tolerance}?{units}?".format(
        numeric=number_pat, tolerance=tolerance_pat, units=units_pat
    )

    # This matches numbers or quantities.
    number_or_quantity_re: typing.Pattern = re.compile(
        r"^" + number_or_quantity_pat + r"$"
    )
    ...
    def is_number_or_quantity(self, validate: bool = False) -> bool:
        ...
        m: typing.Optional[typing.Match] = KgtkValue.number_or_quantity_re.match(
            self.value
        )
        if m is None:
            return False
        ...
        if (
            low_tolerancestr is not None
            or high_tolerancestr is not None
            or si_units is not None
            or wikidata_node is not None
        ):
    ...
    def is_quantity(self, validate: bool = False) -> bool:
        ...
        if (
            low_tolerancestr is None
            and high_tolerancestr is None
            and si_units is None
            and wikidata_node is None
        ):
    ...
    def is_string(self, validate: bool = False) -> bool:
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=KgtkFormat.DataType.STRING,
                valid=self.valid,
                text=m.group("text"),
            )
        return True
    ...
    def is_symbol(self, validate: bool = False) -> bool:
        ...
        if (
            self.is_number_or_quantity()
            or self.is_string()
            or self.is_structured_literal()
            or self.is_boolean()
        ):
            return False
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=self.data_type, valid=self.valid, symbol=self.value,
            )
        return True
    ...
    def is_boolean(self, validate: bool = False) -> bool:
        ...
        # Is this a boolean?
        if (
            self.value != KgtkFormat.TRUE_SYMBOL
            and self.value != KgtkFormat.FALSE_SYMBOL
        ):
            return False
    ...
    lax_language_qualified_string_re: typing.Pattern = re.compile(
        r"^'(?P<text>.*)'@(?P<lang_suffix>(?P<lang>[a-zA-Z]{2,3})(?P<suffix>-[a-zA-Z]+)?)$"
    )
    strict_language_qualified_string_re: typing.Pattern = re.compile(
        r"^'(?P<text>(?:[^'\\]|\\.)*)'@(?P<lang_suffix>(?P<lang>[a-zA-Z]{2,3})(?P<suffix>-[a-zA-Z]+)?)$"
    )
    ...
    def is_language_qualified_string(self, validate: bool = False) -> bool:
        ...
        if not LanguageValidator.validate(
            lang_and_suffix.lower(), options=self.options
        ):
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=KgtkFormat.DataType.LANGUAGE_QUALIFIED_STRING,
                valid=self.valid,
                text=m.group("text"),
    ...
    location_coordinates_re: typing.Pattern = re.compile(
        r"^@(?P<lat>{degrees})/(?P<lon>{degrees})$".format(degrees=degrees_pat)
    )

    # The lax degrees pattern allows scientific notation, but not numbers iin
    # other bases or imaginary numbers.
    lax_degrees_pat: str = r"(?:{plus_or_minus}?(?:{integer}|{floatnumber}))".format(
        plus_or_minus=plus_or_minus_pat,
        integer=decinteger_pat,
        floatnumber=floatnumber_pat,
    )
    lax_location_coordinates_re: typing.Pattern = re.compile(
        r"^@(?P<lat>{degrees})/(?P<lon>{degrees})$".format(degrees=lax_degrees_pat)
    )
    ...
    def is_location_coordinates(self, validate: bool = False) -> bool:
        ...
        m: typing.Optional[typing.Match] = KgtkValue.location_coordinates_re.match(
            self.value
        )
        if m is None:
            if (
                self.options.allow_lax_coordinates
                or self.options.repair_lax_coordinates
            ):
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=KgtkFormat.DataType.LOCATION_COORDINATES,
                valid=self.valid,
                latitudestr=latstr,
                latitude=lat,
                longitudestr=lonstr,
    ...
    date_pat: str = r"(?:{year}(?:(?P<hyphen>-)?{month}?(?:(?(hyphen)-){day})?)?)".format(
        year=year_pat, month=month_pat, day=day_pat
    )
    ...
    lax_date_pat: str = r"(?P<date>(?:{year}(?:(?P<hyphen>-)?{month}?(?:(?(hyphen)-){day})?)?))".format(
        year=lax_year_pat, month=lax_month_pat, day=lax_day_pat
    )
    ...
    time_pat: str = r"(?P<time>(?:{hour}(?:(?(hyphen):){minutes}(?:(?(hyphen):){seconds})?)?{zone}?))".format(
        hour=hour_pat, minutes=minutes_pat, seconds=seconds_pat, zone=zone_pat
    )

    precision_pat: str = r"(?P<precision>[0-1]?[0-9])"

    lax_date_and_times_pat: str = r"(?:\^(?P<date_and_time>{date}(?:T{time})?)(?:/{precision})?)".format(
        date=lax_date_pat, time=time_pat, precision=precision_pat
    )
    lax_date_and_times_re: typing.Pattern = re.compile(
        r"^{date_and_times}$".format(date_and_times=lax_date_and_times_pat)
    )
    ...
    def is_date_and_times(self, validate: bool = False) -> bool:
        ...
        m: typing.Optional[typing.Match] = KgtkValue.lax_date_and_times_re.match(
            self.value
        )
        if m is None:
            return False
        ...
        if self.parse_fields:
            self.fields = KgtkValueFields(
                data_type=KgtkFormat.DataType.DATE_AND_TIMES,
                valid=self.valid,
                date=date,
                time=time,
    ...
    def describe(self) -> str:
        ...
        if dt == KgtkFormat.DataType.EMPTY:
            ...
            return (
                "Language Qualified String"
                if self.is_language_qualified_string(validate=True)
                else "Invalid Language Qualified String"
            )
        elif dt == KgtkFormat.DataType.LOCATION_COORDINATES:
            return (
                "Location Coordinates"
                if self.is_location_coordinates(validate=True)
                else "Invalid Location Coordinates"
            )
        elif dt == KgtkFormat.DataType.DATE_AND_TIMES:
            return (
                "Date and Times"
                if self.is_date_and_times(validate=True)
                else "Invalid Date and Times"
            )
        elif dt == KgtkFormat.DataType.EXTENSION:
            return (
                "Extension" if self.is_extension(validate=True) else "Invalid Extension"
            )
        elif dt == KgtkFormat.DataType.BOOLEAN:
...
def main():
    ...
    for value in args.values:
        kv: KgtkValue = KgtkValue(
            value, options=value_options, parse_fields=args.parse_fields
        )
        kv.validate()
        if value == kv.value:
